...
However, an application running across multiple stacks should be implemented to cope gracefully when its component infrastructure stacks are rebuilt, scaled up and down, etc. in order to gain these benefits.
...
## Use case: Splitting stacks by lifecycle
