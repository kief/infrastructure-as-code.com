...
A Template Stack is an [infrastructure stack](/patterns/stack-concept/) that is designed so that its source code can be used to create and manage multiple, consistent instances.
